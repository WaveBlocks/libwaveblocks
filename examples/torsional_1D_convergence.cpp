...
int main() {
	...
	Parameters_Torsional_1D param_gold;
	...
	while(Dt>=2*Dt_gold) {
		...
		{ // Hagedorn
			Parameters_Torsional_1D param_Hagedorn;
		...
		{ // MG4
			Parameters_Torsional_1D param_MG4;
		...
		{ // McL42
			Parameters_Torsional_1D param_McL42;
		...
		{ // McL84
			Parameters_Torsional_1D param_McL84;
		...
		{ // Pre764
			Parameters_Torsional_1D param_Pre764;
