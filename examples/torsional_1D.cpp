...
class Parameters_Torsional_1D {
	...
	public:
		...
		Parameters_Torsional_1D(std::string name)
		 : sigma_x(1.)
		 , T(10)
		 , Dt(0.0001)
		 , eps(0.01)
		 ...
		 , writer("torsional_1D_" + name + ".hdf5")
		{
			coeffs[0] = 1.0;
			packet.eps() = eps;
...
int main() {
	...
	{ // Hagedorn
		Parameters_Torsional_1D param_Hagedorn("Hagedorn");
		...
		propagator_Hagedorn.evolve(param_Hagedorn.T,param_Hagedorn.Dt);
	}

	{ // Semiclassical
		Parameters_Torsional_1D param_Semiclassical("Semiclassical");
	...
	{ // MG4
		Parameters_Torsional_1D param_MG4("MG4");
		...
		propagator_MG4.evolve(param_MG4.T,param_MG4.Dt);
	}

	{ // McL42
		Parameters_Torsional_1D param_McL42("McL42");
		...
		propagator_McL42.evolve(param_McL42.T,param_McL42.Dt);
	}

	{ // McL84
		Parameters_Torsional_1D param_McL84("McL84");
		...
		propagator_McL84.evolve(param_McL84.T,param_McL84.Dt);
	}

	{ // Pre764
		Parameters_Torsional_1D param_Pre764("Pre764");
		...
		propagator_Pre764.evolve(param_Pre764.T,param_Pre764.Dt);
	}
