...
int main() {
	...
	{ // Hagedorn
		Parameters_Harmonic_1D param_Hagedorn("Hagedorn");
		propagators::HagedornPropagator<P::N,P::D,P::MultiIndex,P::QR,P::Potential,P::Packet_t> pHagedorn(param_Hagedorn.packet,param_Hagedorn.V);
