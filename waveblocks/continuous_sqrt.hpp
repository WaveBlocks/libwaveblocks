...
public:
    ...
    static T continuate(T ref, T arg)
    {
        ...
        // determine, how long one needs to rotate the reference angle counter-clock-wise
        // to hit the angle of the 1st root in the domain = [-2*pi;2*pi].
        T rot = arg - ref;
