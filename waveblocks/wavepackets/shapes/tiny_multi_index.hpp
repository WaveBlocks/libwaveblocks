...
namespace std {
    ...
    struct less< waveblocks::wavepackets::shapes::TinyMultiIndex<UINT,D> >
    {
    private:
        typedef waveblocks::wavepackets::shapes::TinyMultiIndex<UINT,D> MultiIndex;
     ...
     */
    template<class UINT, waveblocks::dim_t D>
    struct hash< waveblocks::wavepackets::shapes::TinyMultiIndex<UINT,D> >
    {
    private:
        typedef waveblocks::wavepackets::shapes::TinyMultiIndex<UINT,D> MultiIndex;
     ...
     */
    template<class UINT, waveblocks::dim_t D>
    struct equal_to< waveblocks::wavepackets::shapes::TinyMultiIndex<UINT,D> >
    {
    private:
        typedef waveblocks::wavepackets::shapes::TinyMultiIndex<UINT,D> MultiIndex;
