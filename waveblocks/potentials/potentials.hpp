...
namespace waveblocks
{
    namespace potentials
    {
        ...
        using InhomogenousMatrixPotential = modules::Inhomogenous<N,D>;

        template<int N, int D>
        using HomogenousMatrixPotential = modules::Homogenous<N,D>;

        template<int D>
        using ScalarMatrixPotential = HomogenousMatrixPotential<1,D>;
    }

    using potentials::InhomogenousMatrixPotential;
    using potentials::HomogenousMatrixPotential;
    using potentials::ScalarMatrixPotential;
