...
\[ 
  \nabla \left( \varepsilon, \Pi, \mathfrak{K}, \boldsymbol{c} \right)
  \rightarrow \left( \varepsilon, \Pi, \mathfrak{K}_{ext},
    \boldsymbol{c_\nabla}, \right)
\]
\begin{algorithm}[H]
  \Input{\(\varepsilon\)}
  ...
  \caption{Computes coefficient vectors after the gradient operator has been applied to the hagedorn wavepacket}
\end{algorithm}
