...
The source code can be found under \texttt{scripts/create\_tables.py} and
\texttt{waveblocks/gauss\_hermite\_qr.hpp}.
...
The implementation resides in \texttt{waveblocks/tensor\_product\_qr.hpp}.
